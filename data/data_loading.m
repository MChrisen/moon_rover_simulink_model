...
% 1. Calculate the change in coordinates (degrees)
delta_lat = diff(lat);
delta_lon = diff(lon);
...
% On the moon, 1 degree of Latitude is ~30,320 meters
...
% Duplicate the last value so the array length matches distance array
